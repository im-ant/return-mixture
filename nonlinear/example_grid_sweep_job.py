# ============================================================================
# Python example script for SLURM submission
# ============================================================================
import copy
...
Experiment_Params_Dict = {
    ...
    'algo.kwargs.sf_lambda': [0.0, 0.4, 0.5, 0.7, 0.95, 1.0],
    ...
    'training.seed': [2, 5, 8, 11, 14, 17, 20, 23, 26, 29],
}
...
StdOut_Dir = ".output/stdout_error"

# The python training script to call
Py_Script = "./train_nonlinear.py"
